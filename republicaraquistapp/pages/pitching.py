    ...
    return rx.box(
        rx.vstack(
            ...
            rx.hstack(
                ...
                rx.select(
                    PitchingState.available_seasons,
                ...
                rx.cond(
                    ...
                    rx.hstack(
                        ...
                        rx.button(
                            ...
                            on_click=PitchingState.update_range,
                        ),
                        align="center",
                        spacing="2",
                    ),
...
def pitcher_header_banner() -> rx.Component:
    ...
    return rx.box(
        rx.vstack(
                ...
                rx.vstack(
                    ...
                    rx.cond(
                        ...
                        rx.cond(
                            PitchingState.time_mode == "season",
                            rx.text(
                                f"Lanza: {p['throws']}HP  |  Temporada Completa {PitchingState.pitcher_season}  |  {PitchingState.summary_games_count} Salidas",
                                size="2",
                                color=TEXT_MUTED,
                            ),
                            rx.text(
                                f"Lanza: {p['throws']}HP  |  Rango: {PitchingState.range_start_date} al {PitchingState.range_end_date}  |  {PitchingState.summary_games_count} Salidas",
                                size="2",
                                color=TEXT_MUTED,
                            ),
                        ),
            ...
            rx.grid(
                kpi_pill("IP", PitchingState.active_kpi_ip),
                kpi_pill("H", PitchingState.active_kpi_h),
                kpi_pill("R", PitchingState.active_kpi_r),
                kpi_pill("ER", PitchingState.active_kpi_er),
                kpi_pill("BB", PitchingState.active_kpi_bb),
                kpi_pill("K", PitchingState.active_kpi_so, highlight=True),
                kpi_pill("PITCHES", PitchingState.active_kpi_pitches),
                kpi_pill(rx.cond(PitchingState.time_mode == "game", "CSW%", "ERA"), PitchingState.active_kpi_rate1, highlight=True),
                kpi_pill(rx.cond(PitchingState.time_mode == "game", "WHIFF%", "WHIP"), PitchingState.active_kpi_rate2, highlight=True),
                columns="9",
                spacing="2",
                width="100%",
                margin_top="0.5rem",
