    ...
    return rx.vstack(
        ...
        rx.box(
            rx.vstack(
                ...
                rx.plotly.cartesian(data=SprayState.spray_chart_figure, height="680px", width="100%"),
                spacing="3",
                width="100%",
            ),
            style=CARD_STYLE,
    ...
    return rx.vstack(
        ...
        rx.box(
            rx.vstack(
                ...
                rx.plotly.cartesian(data=SprayState.strike_zone_figure, height="620px", width="100%"),
                spacing="3",
                width="100%",
            ),
            style=CARD_STYLE,
