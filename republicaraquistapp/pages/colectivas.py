    ...
    return rx.vstack(
        ...
        rx.box(
            rx.vstack(
                ...
                rx.plotly.cartesian(data=ColectivasState.batting_bar_chart),
                spacing="3",
                width="100%",
            ),
            style=CARD_STYLE,
    ...
    return rx.vstack(
        ...
        rx.box(
            rx.vstack(
                ...
                rx.plotly.cartesian(data=ColectivasState.pitching_bar_chart),
                spacing="3",
                width="100%",
            ),
            style=CARD_STYLE,
    ...
    return rx.vstack(
        ...
        rx.box(
            rx.vstack(
                ...
                rx.plotly.cartesian(data=ColectivasState.fielding_bar_chart),
                spacing="3",
                width="100%",
            ),
            style=CARD_STYLE,
