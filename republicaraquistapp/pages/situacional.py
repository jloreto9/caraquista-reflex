        ...
        rx.grid(
            ...
            rx.box(
                rx.vstack(
                    ...
                    rx.plotly.cartesian(data=SituationalState.ops_chart_figure, height="400px", width="100%"),
                    spacing="3",
                    width="100%",
                ),
                style=CARD_STYLE,
        ...
        rx.grid(
            ...
            rx.box(
                rx.vstack(
                    ...
                    rx.plotly.cartesian(data=SituationalState.lob_chart_figure, height="360px", width="100%"),
                    spacing="3",
                    width="100%",
                ),
                style=CARD_STYLE,
